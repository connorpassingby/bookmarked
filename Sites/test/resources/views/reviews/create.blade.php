    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/reviews">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="media_type"
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="summary" rows="10"
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="reviewer"
