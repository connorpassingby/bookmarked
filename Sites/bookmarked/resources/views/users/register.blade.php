<x-layout>
    <x-card class="p-[50px] max-w-lg mx-auto mt-20 bg-form border-white rounded-[50px]">
        ...
        <form method="POST" action="/users" class="grid grid-cols-5">
            @csrf
            <div class="mb-2 col-span-5">
                ...
                <input type="text" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                    name="uname" value="{{ old('uname') }}" placeholder="Username" />
            ...
            <div class="col-span-5 flex gap-2">
                <div class="mb-2">
                    ...
                    <input type="number" class="rounded-[50px] bg-input text-center placeholder-gray-600 p-2 w-full"
                        name="cluster" value="{{ old('cluster') }}" placeholder="Cluster No." />
                    @error('cluster')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="number" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                        name="bld" value="{{ old('bld') }}" placeholder="Building No." />
                    @error('bld')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="number" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                        name="flr" value="{{ old('flr') }}" placeholder="Floor no." />
                    @error('flr')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="number" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                        name="unit" value="{{ old('unit') }}" placeholder="Unit No." />
                    @error('unit')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-2 col-span-5">
                ...
                <input type="text" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                    name="birthday" value="{{ old('birthday') }}" placeholder="Birthday (YYYY-MM-DD)" />
            ...
            <div class="mb-2 col-span-5">
                ...
                <input type="text" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
                    name="contact" value="{{ old('contact') }}" placeholder="Contact No." />
            ...
            <div class="mb-2 col-span-5">
                ...
                <input type="email" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
            ...
            <div class="mb-2 col-span-5">
                ...
                <input type="password" class="rounded-[50px] bg-input placeholder-gray-600 text-center p-2 w-full"
            ...
            <div class="col-span-5 mt-9 mb-6 text-center text-lg">
                <button type="submit" class="bg-main text-white py-3 px-[143px] rounded-[50px] hover:bg-black">
                    SIGNUP
                </button>
            </div>

            <div class="col-span-5 mt-8 text-center">
                <p>
